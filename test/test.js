...
/*     StrectchCell   */
/**********************/
describe("StrectchCell", function() {
    var valueStrectchCell = "Title";
    var Width = 5;
    var Height = 2;
  it("Creation of StrectchCell", function() {
    var StrectchCell = new StretchCell(valueStrectchCell,1,2);
    //assert(Width === StrectchCell.minWidth());
    assert(Height === StrectchCell.minHeight());
  })
});
